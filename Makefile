...
release_object_files/%.o: color_print/%.cpp#добавлено из-за того, что color_print в отдельной папке
	$(CC) -c $(RFLAGS) $< -o $@ #более умного способа я не придумал
